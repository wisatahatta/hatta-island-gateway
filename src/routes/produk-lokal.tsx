...
import manisan from "@/assets/manisan.webp";
  ...
  head: () => ({
    meta: [
      { title: "Produk Lokal & Hasil Bumi — Pulau Hatta" },
      {
        name: "description",
        content:
          "Biji pala, fuli, dan manisan pala khas Desa Rozengain — langsung dari produsen ke pembeli.",
      },
...
const products = [
  {
    name: "Biji Pala Pilihan",
    desc: "Pala kering kualitas export dari kebun warisan keluarga di Rozengain.",
    img: nutmeg,
    tag: "Rempah",
  },
  {
    name: "Fuli / Bunga Pala",
    desc: "Selubung merah pala yang langka, harum, dan kaya cita rasa.",
    img: fuli,
    tag: "Rempah",
  },
  {
    name: "Manisan Pala",
    desc: "Manisan tradisional dari daging buah pala segar, menawarkan perpaduan rasa manis dan hangat khas Banda.",
    img: manisan,
    tag: "Oleh-oleh",
  },
];
    ...
    <>
      <section className="relative text-primary-foreground overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8 py-20 lg:py-28">
          ...
          <h1 className="mt-3 font-display text-5xl lg:text-6xl max-w-3xl font-bold leading-tight">
            Produk Lokal & Hasil Bumi
          </h1>
          <p className="mt-5 max-w-2xl text-primary-foreground/85 text-base md:text-lg leading-relaxed">
            Pala dan fuli Banda telah mengubah jalan sejarah dunia. Kini, hasil bumi Rozengain dapat
            Anda bawa pulang langsung dari produsennya.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 lg:px-8 py-16 lg:py-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((p) => (
            <article
              key={p.name}
              className="group rounded-2xl overflow-hidden bg-card border border-border hover:shadow-[var(--shadow-glow)] transition-all duration-500"
            >
              ...
              <div className="p-5">
                <span className="text-[10px] uppercase tracking-[0.18em] text-spice font-semibold">
                  {p.tag}
                </span>
        ...
        <div className="mt-16 rounded-3xl bg-spice text-spice-foreground p-10 lg:p-14 text-center">
          ...
          <p className="mt-3 max-w-xl mx-auto text-spice-foreground/90">
            Kirim pesan WhatsApp ke pengelola desa untuk detail harga, berat, dan pengiriman ke kota
            Anda.
          </p>
